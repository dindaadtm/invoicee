                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control form-textarea"
                                                             name="alamat" placeholder="Alamat" required><?= @$row->alamat ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control form-textarea"
                                                             name="ket" placeholder="Keterangan" required><?= @$row->ket ?></textarea>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#input_data').on('submit', function (e) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url('admin/Customers/edit_data') ?>",
                    cache: false,
                    ...
                    success: function (data) {
                        if (data.msg == 'success') {
                            ...
                            setTimeout(function () {
                                window.location =
                                    "<?php echo base_url('admin/Customers/data') ?>";
                            }, 2000)
                        } else {
