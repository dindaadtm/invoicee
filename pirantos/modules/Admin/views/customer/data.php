<section class="pcoded-main-container">
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="zero-configuration"
                                                ...
                                                <tbody>
                                                    <?php
                                                    $get_customer = $this->db->get('data_customer')->result();
    ...
    <script>
        function get_detail(id) {
            window.location = ('<?= base_url() ?>admin/Customers/detail/' + id)
        }

        function get_edit(id) {
            window.location = ('<?= base_url() ?>admin/Customers/edit/' + id)
        }
    ...
    <script>
        ...
        function act_delete(id) {
            where_value = id;
            where_field = 'id';
            table_name = 'data_customer';
            $('.loading').show();
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/Customers/delete_data') ?>",
                cache: false,
                data: {
