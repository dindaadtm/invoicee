 ...
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/amchart/js/amcharts.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/amchart/js/gauge.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/amchart/js/serial.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/amchart/js/light.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/amchart/js/pie.min.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/amchart/js/ammap.min.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/amchart/js/usaLow.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/amchart/js/radar.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/amchart/js/worldLow.js"></script> 
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/notification/js/bootstrap-growl.min.js"></script> 
 <script src="<?php echo base_url() ?>prabotan/admin/js/pages/dashboard-custom.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/data-tables/js/datatables.min.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/js/pages/tbl-datatable-custom.js"></script>
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/pnotify/js/pnotify.custom.min.js"></script>  
 <script src="<?php echo base_url() ?>prabotan/admin/plugins/summernote/summernote-bs4.js"></script>
 <script src="<?php echo base_url() ?>prabotan/js/form_generator.js"></script> 
</body>

</html>
<script>
$(function() {   
	$('#sukses_menyimpan').on('click', function () {
		new PNotify({
	...
	$('#sukses_menghapus').on('click', function () {
		new PNotify({
			title: 'Success notice',
	...
	$('#gagal_menghapus').on('click', function () {
		new PNotify({
			title: 'Warning notice',
			text: 'Data failed to delete, Please try again !',
			type: 'danger'
		});
	});
	$('#gagal_menyimpan').on('click', function () {
		new PNotify({
			title: 'Warning notice',
			text: 'Data failed to save, Please try again !',
			type: 'danger'
		});
	});
	$('#error_menyimpan').on('click', function () {
		new PNotify({
			title: 'Warning notice',
			text: 'An error occurred when saved, Please try again or contact IT Support !',
			type: 'danger'
		});
	});
	$('#tersedia').on('click', function () {
		new PNotify({
			title: 'Warning notice',
			text: 'Your email has been used by someone else, use another email !',
			type: 'danger'
		});
	});
})
...
! function(e) {
    ...
    e.sessionTimeout = function(t) {
        ...
        var a, r = {
                ...
                ajaxType: "POST",
                ajaxData: "",
                redirUrl: "<?php echo base_url('authenticate/logout') ?>",
                logoutUrl: "<?php echo base_url('authenticate/logout') ?>",
                warnAfter: 9e5,
                redirAfter: 12e5,
