<section class="pcoded-main-container">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" required
                                                            name="nama_perusahaan" placeholder="Name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control form-textarea"
                                                            required name="alamat" placeholder="Alamat"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control form-textarea"
                                                            required name="ket" placeholder="Keterangan"></textarea>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        $('#input_data').submit(function () {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/Vendors/insert_data') ?>",
                cache: false,
                data: $(this).serialize(),
                dataType: 'json',
                success: function (data) {
                    if (data.msg == 'success') {
                        ...
                        setTimeout(function () {
                            window.location = "<?php echo base_url('admin/Vendors') ?>";
                        }, 2000)
